...
import com.emergence.study_app.newTech.retrofit.model.responsePurchasedTestSeries.DataItem;
import com.emergence.study_app.testSeriese.PurchaseTestSeriesDetail;
import com.example.study_app.R;

import java.util.List;

public class PurchasedTestSeriesAdapter extends RecyclerView.Adapter<PurchasedTestSeriesAdapter.AdapterViewHolder> {
  Context context;
  List<DataItem> dataItems;

    public PurchasedTestSeriesAdapter(Context context, List<DataItem> dataItems) {
    ...
    @NonNull
    @Override
    public PurchasedTestSeriesAdapter.AdapterViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull PurchasedTestSeriesAdapter.AdapterViewHolder holder, int position) {
        ...
        holder.tv_view_detail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(context, PurchaseTestSeriesDetail.class);
