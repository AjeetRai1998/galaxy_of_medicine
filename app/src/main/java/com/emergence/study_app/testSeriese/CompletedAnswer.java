...
import com.emergence.study_app.Adapter.AnswerAdapter;
...
public class CompletedAnswer extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_completed_answer);
        preferencesManager=new PreferencesManager(CompletedAnswer.this);
    ...
    private void AddExamRecycler(String sid) {
        ...
        Call<ResponseAnswerList> call=apiServices.answerList("GetCompleteTestsDetails",preferencesManager.getUserId(), sid);
        call.enqueue(new Callback<ResponseAnswerList>() {
            ...
            public void onResponse(Call<ResponseAnswerList> call, Response<ResponseAnswerList> response) {
                ...
                if (response.body().getRes().equalsIgnoreCase("success")){
                    ...
                    recyc_ans.setAdapter(new AnswerAdapter(getApplicationContext(),response.body().getData()));
