...
public class QuizAdapter extends RecyclerView.Adapter<QuizAdapter.QuestionViewHolder> {
    ...
    public QuizAdapter(Context context, List<DataItem> models, MVPClass mvpClass) {
    ...
    @NonNull
    @Override
    public QuizAdapter.QuestionViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull QuizAdapter.QuestionViewHolder holder, int position) {
         ...
         //   holder.rad_group.setOrientation(LinearLayout.VERTICAL);
            ...
            holder.rad_group.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(RadioGroup radioGroup, int i) {
                    if (i == R.id.ans_1) {
                        QuizQuestion.ans = holder.ans_1.getText().toString();
                    } else if (i == R.id.ans_2) {
                        QuizQuestion.ans = holder.ans_2.getText().toString();

                    } else if (i == R.id.ans_3) {
                        QuizQuestion.ans = holder.ans_3.getText().toString();

                    } else if (i == R.id.ans_4) {
                        QuizQuestion.ans = holder.ans_4.getText().toString();
                    }
                }
            });
            holder.tv_skip_question.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    QuizQuestion.last_Index = "";
                    QuizQuestion.ans = "notattempt";
        ...
        holder.tv_skip_question.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (models.get(position).getStatus().equalsIgnoreCase("0")){
                    QuizQuestion.Quest_status="0";
                    QuizQuestion.last_Index = "";
                    QuizQuestion.ans = "notattempt";
                    mvpClass.giveAnswer(String.valueOf(position), models.get(position).getId(), "ans");
                }else {
                    QuizQuestion.Quest_status="1";
                    QuizQuestion.last_Index = "";
                    QuizQuestion.ans = "notattempt";
                    mvpClass.giveAnswer(String.valueOf(position), models.get(position).getId(), "ans");
                }
