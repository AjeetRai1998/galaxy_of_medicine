...
public class QuizAnswerAdapter extends RecyclerView.Adapter<QuizAnswerAdapter.AdapterViewHolder> {
    Context context;
    List<DataItem> models;

    public QuizAnswerAdapter(Context context, List<DataItem> models) {
    ...
    @NonNull
    @Override
    public QuizAnswerAdapter.AdapterViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull QuizAnswerAdapter.AdapterViewHolder holder, int position) {
        int sum=0;
        int minus=0;
        int obtain=0;
        int total_marks=0;
