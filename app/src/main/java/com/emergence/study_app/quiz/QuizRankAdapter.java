...
public class QuizRankAdapter extends RecyclerView.Adapter<QuizRankAdapter.AdapterViewHolder> {
    Context context;
    List<DataItem> model;

    public QuizRankAdapter(Context context, List<DataItem> model) {
    ...
    @NonNull
    @Override
    public QuizRankAdapter.AdapterViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull QuizRankAdapter.AdapterViewHolder holder, int position) {
